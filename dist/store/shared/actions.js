				...
				while (1) {
					switch (_context9.prev = _context9.next) {
						case 0:
							...
							_context9.next = 4;
							return _api2.default.ajax.cart.updateShippingAddress(cart.shipping_address);
...
var updateShippingAddress = exports.updateShippingAddress = function updateShippingAddress(shippingAddress) {
	return function () {
			...
			return regeneratorRuntime.wrap(function _callee11$(_context11) {
				while (1) {
					switch (_context11.prev = _context11.next) {
						case 0:
							_context11.next = 2;
							return _api2.default.ajax.cart.updateShippingAddress(shippingAddress);
...
var updateBillingAddress = exports.updateBillingAddress = function updateBillingAddress(billingAddress) {
	return function () {
			...
			return regeneratorRuntime.wrap(function _callee12$(_context12) {
				while (1) {
					switch (_context12.prev = _context12.next) {
						case 0:
							_context12.next = 2;
							return _api2.default.ajax.cart.updateBillingAddress(billingAddress);
			...
			return regeneratorRuntime.wrap(function _callee13$(_context13) {
				while (1) {
					switch (_context13.prev = _context13.next) {
						...
						case 23:
							sitemapResponse = _context13.sent;
